...
IconButton.Collapse = function CollapseIconButton({
  ...
  return (
    <button
      ...
      title={title}
    >
      <svg className={styles.collapseChevron} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
IconButton.Fullscreen = function FullscreenIconButton({
  ...
  return (
    ...
    >
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M2 5V2H5M14 5V2H11M14 11V14H11M2 11V14H5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </button>
  );
};
