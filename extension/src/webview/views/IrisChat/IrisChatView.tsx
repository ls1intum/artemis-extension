...
export function IrisChatView({ vscodeApi }: IrisChatViewProps) {
    ...
    }, [setIrisState, setShowDiagnostics, addMessage, applyLoadedMessages, setReferencedFiles, setWebSocketStatus, setDisabledMessage, setUnavailableMessage, setNoAiDetected, resetTransientChatUi, applyRunUi, applyCommit, markMessageFailed, removeMessageById, foldEpisode, setLiveEpisode, resolveOffer, foldAllEpisodes, setOpenSessionError, mergeLoadedMessages, confirmSentMessage, showNotice]);
