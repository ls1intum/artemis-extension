 ...
 * not carry (delivery throttle, B4 grace). All "remaining" values are derived here from the
...
export function formatTick(t: TickRecord, snap?: StruggleDebugSnapshot): string {
    ...
    // The two severity components. sBase = (fTyping + fGap) / 2 is the value the decision reads.
