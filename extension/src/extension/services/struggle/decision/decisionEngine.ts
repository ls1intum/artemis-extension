 ...
 *    S_base at θ=0.7). Delegates to the AlertStateMachine, which owns hysteresis,
 *    the over-θ span, E6, the cooldown and the B2/B4/warmup gates.
 ...
 * the DecisionEngine identical to alerts_full_u, which is the golden surface.
